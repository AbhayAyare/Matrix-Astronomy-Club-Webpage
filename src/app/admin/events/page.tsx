...
// Helper function to generate unique IDs for Alert Dialog Title and Description
...
export default function AdminEventsPage() {
  ...
  // Generate stable IDs using the helper functions
  ...
  }, [db]); // Removed toast from dependency array as it can cause loops if context changes
  ...
  const handleSaveEvent = async (e: React.FormEvent) => {
    ...
    const eventData = {
      ...
      imageURL: eventImageURL || null, // Store null if empty string
    ...
    try {
      if (editEventId) {
        ...
        // Update local state correctly, ensuring date is a Timestamp for sorting/display logic
        ...
        // Create new event object with consistent types for local state
        const newEvent: Event = {
            id: docRef.id,
            name: eventData.name,
            date: eventData.date, // Already a Timestamp
            description: eventData.description,
            imageURL: eventData.imageURL ?? undefined, // Convert null back to undefined if needed
            createdAt: Timestamp.now() // Use actual timestamp for sorting consistency
        };
    ...
    <div className="space-y-6">
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent
           ...
           aria-labelledby={eventDialogTitleId} // Use generated ID
           aria-describedby={eventDialogDescriptionId} // Use generated ID
        >
          <DialogHeader>
            <DialogTitle id={eventDialogTitleId}> {/* Use generated ID */}
              {editEventId ? 'Edit Event' : 'Add New Event'}
            </DialogTitle>
            <DialogDescription id={eventDialogDescriptionId}> {/* Use generated ID */}
          ...
          <form onSubmit={handleSaveEvent} className="space-y-4 py-4">
            ...
            <div className="space-y-1">
              ...
              <Textarea
                ...
                required
                disabled={saving || isOffline}
                className="text-primary-foreground placeholder:text-gray-300" // Use foreground color for text
              />
            </div>
            <div className="space-y-1">
                  ...
                  <div className="flex gap-2 mt-2 sm:mt-0 shrink-0">
                    ...
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
                       ...
                       {/* Ensure AlertDialogContent has Header, Title, and Description for accessibility */}
                       <AlertDialogContent
